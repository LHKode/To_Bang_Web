                            ...
                            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="box-body">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control" name="parent_id">
                                                ...
                                                <?php foreach($categorySort as $cs) :?>
                                                    <option value="<?= $cs['id_danhmuc'] ?>"><?php $str = '' ;for($i = 0; $i < $cs['level'] ; $i++) {echo $str ; $str.=" -- ";} ?> <?= $cs['tendanhmuc'] ?> </option>
                                                <?php endforeach ;?>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="cpr_name" id="inputEmail3" placeholder="Hoa tươi đà lạt" autocomplete="off" value="<?= isset($name) ? $name : ''?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="icon" id="inputEmail3" placeholder="fa fa-dashboard" autocomplete="off" value="<?= isset($icon) ? $icon : ''?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-2 control-label"> Màu  </label>
                                        <div class="col-sm-10">
                                            <input type="color" class="form-control" name="color" id="inputEmail3" placeholder="fa fa-dashboard" autocomplete="off" value="<?= isset($color) ? $color : ''?>" style="width: 10%;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10" style="margin-top: 10px;margin-left: 17%">
                                            <img src="<?= base_url('/public/uploads/') ?><?= isset($_SESSION['hinhanh']) ? $_SESSION['hinhanh'] : '' ?>" alt="" class="img img-responsive" id="blah" title=" Logo " style="width: 260px;height: 258px;border: 1px solid #dedede">
