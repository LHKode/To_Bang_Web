...
if($_SERVER['REQUEST_METHOD'] == 'POST')
{
    ...
    {
        $errors['p_thunbar'] = "  Mời bạn chọn hình  ảnh!!! ";
    }
                        ...
                        <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                            <div class="box-body">
                                ...
                                <div class="col-sm-8">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="p_title" value="<?= isset($name) ? $name : '' ?>"  placeholder=" Tên sản phẩm không quá 200 từ" autocomplete="off">
                            ...
                            <div class="form-group" style="margin:5px 0">
                                ...
                                <div class="col-sm-12" style="padding-left: 30px ;padding-right: 30px">
                                    <textarea name="p_content" id="my-editor" cols="10" rows="10" class="form-control" placeholder=" Mời bạn nhập nội dung bài viết "><?= isset($content) ? $content : '' ?></textarea>
