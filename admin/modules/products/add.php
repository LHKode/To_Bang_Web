<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST')
    {
        ...
        if ( count($errors)  == 1)
        {
            ...
            //tiến hành insert
            $id_insert = DB::insert('tbl_sanpham',$data);
                                ...
                                <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10" style="margin-top: 10px;margin-left: 17%">
                                                    <img src="<?= base_url('/public/uploads/') ?><?= isset($_SESSION['hinhanh']) ? $_SESSION['hinhanh'] : '' ?>" alt="" class="img img-responsive" id="blah" title=" Logo " style="width: 100%;height: 258px;border: 1px solid #dedede">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-8">
                                                    ...
                                                    <select class="form-control" name="prd_category_product_id">
                                                        ...
                                                        <?php if(count($categorySort) > 0) :?>
                                                            <?php foreach($categorySort as $catep) :?>
                                                                <option value="<?= $catep['id_danhmuc'] ?>" <?= isset($cate) && $cate == $catep['id_danhmuc'] || (isset($_SESSION['cate']) && $_SESSION['cate'] == $catep['id_danhmuc'] ) ? 'selected="selected"' : '' ?> ><?php $str = '' ;for($i = 0; $i < $catep['level'] ; $i++) {echo $str ; $str.=" -- ";} ?> <?php echo $catep['tendanhmuc'] ?></option>
                                                            <?php endforeach ;?>
                                                        <?php endif; ?>
                                                    </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-4">
                                                    <input type="text"  placeholder="Mã sản phẩm" readonly name="prd_code" id="code_sale" class="form-control" value="<?= isset($masp) ? $masp : '' ?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input type="number" min="0" max="10" placeholder=" 1 - 10 (%)" name="prd_sale" class="form-control" value="<?= isset($sale) ? $sale : '0' ?>">
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-group" style="margin: 5px 0">
                                        ...
                                        <div class="col-sm-12" style="padding-left: 30px ;padding-right: 30px">
                                            <textarea name="khuyenmai"  cols="10" id="prd_description" rows="3" class="form-control wysihtml5" placeholder="Nội dung khuyến mãi"><?= isset($khuyenmai) ? $khuyenmai : '' ?></textarea>
                                        </div>
                                    ...
                                    <div class="form-group" style="margin: 5px 0">
                                        ...
                                        <div class="col-sm-12" style="padding-left: 30px ;padding-right: 30px">
                                            <textarea name="prd_description"  cols="10" id="prd_description" rows="3" class="form-control wysihtml5" placeholder=" Mô tả ngắn về nội dung bài viết , không quá 250 ký tự"><?= isset($description) ? $description : '' ?></textarea>
