					...
					<div class="col-lg-12">
						<div class="hastech-404-area-list">
							...
							<div class="error-heading">
								<h2>Trang này hiện không có sẵn</h2>
								<h3>Chúng tôi xin lỗi, nhưng địa chỉ bạn đang truy cập không còn hoạt động</h3>
							</div>
							<div class="error-form">
								<p>Để tìm sẵn phẩm, hãy nhập vào phía dưới</p>
							...
							<div class="error-back-home">
								<a class="add-tag-btn" href="index.html"><i class="fa fa-chevron-left"></i> Trang chủ:</a>
							</div>
						</div>
					</div>
				</div>
