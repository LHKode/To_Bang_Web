<?php
    ...
    $sql = "SELECT * FROM  tbl_sanpham WHERE danhmuc_id = ".$id ." AND trangthai = 1 ORDER BY id_sanpham DESC";
                        ...
                        <div class="col-md-9">
                            <div class="breadcrumb clearfix">
                                <ul>
                                    ...
                                    <?php 
                                        $dataCate = DB::fetchOne('tbl_danhmuc', ' id_danhmuc = "'.$id.'"');
                                    ...
                                    <li itemtype="" itemscope="" class="category17 icon-li">
                                        <div class="link-site-more">
                                            <a title="" href="chi-tiet-danh-muc.php?id=<?php echo $dataCate['id_danhmuc'] ?>" itemprop="url">
                                            <span itemprop="title"><?php echo $dataCate['tendanhmuc'] ?></span>
                                            </a>
                                        </div>
                                    </li>
                                </ul>
                            ...
                            <div id="view-product-list" class="view-product-list">
                                <h2 class="page-heading">
                                    <span class="page-heading-title"><?php echo $dataCate['tendanhmuc'] ?></span>
                                </h2>
                                <!-- PRODUCT LIST -->
