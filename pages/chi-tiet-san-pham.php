<?php
    ...
    $comment = DB::query('comments' ,'*',' and cmt_product_id = ' .$id . ' ORDER BY ID DESC lIMIT 4' );
                    ...
                    <section class="box-main1" >
                            ...
                            <div class="col-md-6 bor" style="margin-top: 20px;padding: 30px;">
                               <ul id="right">
                                    ...
                                    <li>
                                        Tình trạng : <span style="color:red"><?= $product['prd_number'] > 0 ? " Còn hàng "  : " Hết Hàng "?></span> | <span class="view" >Lượt xem <i class="fa fa-eye" style="background: none;color: #666"></i> <?= $product['prd_view'] ?></span>
                                    </li>
                                    <li>
                                                        ...
                                                        <div class="col-sm-6" style="margin-bottom:5px;">
                                                            <div class="media">
                                                                    <div class="media-left">
                                                                        <img src="/public/user-default.png" class="media-object" style="width:60px">
                                                                    </div>
