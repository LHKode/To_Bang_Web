var frontend = {
    ...
    {   
        ...
        $('#vanchuyen').change(function() {
            ...
            var fee = $(this).find(":selected").val();
            ...
            if(fee == 1) {
                ...
                var tongtien = parseFloat(thanhtien) + 50000;
                $('#tongtien').val(tongtien);
                $('#phivanchuyen').html('50000đ');
                tongtien = formatNumber(tongtien.toString())+'đ';
                $('#text-tong-tien').html(tongtien);
            } else {
                var thanhtien = $('#thanhtien').val();
                var tongtien = parseFloat(thanhtien) + 30000;
                $('#tongtien').val(tongtien);
                $('#phivanchuyen').html('30000đ');
                tongtien = formatNumber(tongtien.toString())+'đ';
                $('#text-tong-tien').html(tongtien);
            }
        });
