...
<script type="text/javascript">
    ...
    var ShoppingCart = {
        ...
        configSelect : {
            'classElementRemoveItemCart'     : '.remove-item-cart', 
            'classElementChangeQtyItemCart'  : '.item-qty-cart',
            'classElementTotalPriceItemCart' : '',
            'idElementTotalPriceCart'        : '',
            'idElementSubTotalPriceCart'     : ''
        },
        ...
        init : function()
        {
            ...
            _this.clickChangeQtyItemCart();
        },

        clickChangeQtyItemCart : function()
        {
            let _this = this;

            $(_this.configSelect.classElementChangeQtyItemCart).click(function()
            {
                $(".load-wrapp").remove();
                let qty = $(this).val();
                string  = '<div class="load-wrapp">\
                                <div class="load-4">\
                ...
                $(this).css('opacity','0.5').parents('td').css({'position':'relative'}).append(string);
                

                $.ajax({
                    url       : "/index.php",
                    method    : "post",
                    data      : "Dữ Liệu Mẫu Gủi Sang PHP ",
                    beforeSend: function () {
                        $('.load-wrapp').css('display','block').hide().fadeIn();
                    ...
                    complete  : function () {
                        setTimeout(function(){
                            $('.load-wrapp').css('display','none').hide().fadeOut();
                        }, 30000000);
                    }
                });
            })
